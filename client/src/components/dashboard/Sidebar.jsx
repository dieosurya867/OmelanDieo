...
import Logo from "../../images/dashboard/logo/logo.svg";
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-[color:var(--sidebar-foreground)] bg-[color:var(--sidebar)] hover:bg-[color:var(--sidebar-accent)]`}
                >
                  <svg
                    className="fill-current"
                    width="18"
